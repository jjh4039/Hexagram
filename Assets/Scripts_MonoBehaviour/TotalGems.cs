...
public class TotalGems : MonoBehaviour
{
    ...
    public class UpgradeRow
    {
        ...
        [Tooltip("마이너스 버튼 하단 텍스트 (-비용)")] public TextMeshProUGUI minusCostText;

        [Tooltip("플러스 버튼 하단 텍스트 (+비용)")] public TextMeshProUGUI plusCostText;

        public TextMeshProUGUI effectText;
        public TextMeshProUGUI levelText; // 현재 레벨 표시 텍스트

        [Header("Settings")] public int costPerLevel = 1;
        public int maxLevel = 10;

        [Header("Value 1")] public float value1PerLevel = 20f;
        public int levelStep1 = 1;

        [Header("Value 2")] public float value2PerLevel = 0f;
        public int levelStep2 = 1;

        [Header("Format")] public string effectTextFormat = "+{0}";
    }
    ...
    private TextMeshProUGUI topTotalGemsText;

    [SerializeField] private TextMeshProUGUI bottomRemainingText;

    [Header("Upgrades")] [SerializeField] private UpgradeRow[] upgradeRows;

    [Header("Animation Settings")] [SerializeField]
    private float targetBgWidth = 800f;

    [SerializeField] private float bgExpandDuration = 0.25f;

    [Header("Sound")] [SerializeField] private AudioClip sfxOpen;
