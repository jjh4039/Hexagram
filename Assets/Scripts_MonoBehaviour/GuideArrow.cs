...
public class GuideArrow : MonoBehaviour
{
    ...
    [Header("Settings")] public float radius = 0.55f; // 화살표 회전 반경
    ...
    [Header("Sprites")] public Sprite rewardSprite; // 보상 방향 이미지
    public Sprite statueSprite; // 동상 방향 이미지

    [Header("Runtime")] public bool isVisible = false; // 화살표 활성화 상태
