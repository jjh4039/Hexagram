...
public class MapManager : MonoBehaviour
{
    ...
    [SerializeField] private AudioClip sfxCount; // �� [�߰�] ī���� ���� (ƽ! �Ҹ�)
    ...
    private IEnumerator ScanSequence()
    {
        ...
        {
            StageData data = currentNodes[i];
            if (stageTitleText != null) stageTitleText.text = $"��� : {data.stageName}";
    ...
    private IEnumerator ProcessSelectSequence()
    {
        ...
        // �� [�߰�] ���� ��� Ÿ�̸�
        float soundTimer = 0f;
        float soundInterval = 0.07f; // 0.07�ʸ��� ƽ �Ҹ�
        ...
        while (elapsed < duration)
        {
            ...
            if (totalProgressText != null)
                totalProgressText.text = $"���൵ : <color=#80FF80>��_{currentTotalVal}%</color>";
