...
{
    [Header("--- Module Settings ---")] public StageModuleType moduleType;
    ...
    [Header("--- Visuals ---")] public Sprite moduleIcon;

    [Header("--- Season Prefabs ---")] [Tooltip("[0]:봄, [1]:여름, [2]:가을, [3]:겨울 순서로 프리팹을 넣어주세요.")]
